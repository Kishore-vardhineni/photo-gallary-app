...
import { getForgotPassword } from "../services/authService";
import { forgotPasswodSchema } from "../validation/forgotPasswodSchema";
...
const ForgotPassword = () => {
    ...
    const {
        ...
        resolver: yupResolver(forgotPasswodSchema),
    });

    const onSubmit = async (data) => {
        try {
            const response = await getForgotPassword(data);
