...
const UserPhotos = () => {
  ...
  return (
  <div className="min-h-screen bg-gradient-to-br from-gray-100 via-purple-100 to-blue-100 p-3 sm:p-4 md:p-6 lg:p-8 xl:p-10 mt-10">
    ...
    <div className="flex flex-col md:flex-row gap-3 mb-6">
      ...
      {/* ADD BUTTON */}
      <button className="bg-yellow-500 hover:bg-yellow-600 text-black font-semibold px-4 py-2 rounded-xl shadow w-full sm:w-auto">
    ...
    <div className="flex justify-end mt-8 gap-2">
      ...
      <button className="px-3 py-1 bg-yellow-500 text-black rounded">Next</button>
    </div>
